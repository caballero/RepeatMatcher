...
#
#   $Log: FastaDB.pm,v $
#   Revision 1.86  2011/04/26 22:41:44  rhubley
...
"FastaDB::_cleanIndexAndCompact(): Fasta file contains a sequence identifier "
    ...
    if ( /^[ACGTBDHVRYKMSWNXacgtbdhvrykmswnx]+$/ ) {
      ...
      if (
/([ACGTBDHVRYKMSWNXacgtbdhvrykmswnx\s]{0,5}[^ACGTBDHVRYKMSWNXacgtbdhvrykmswnx\s>]+.{0,5})/
          )
      {
        print STDERR "  The offending subsequence is \"$1\". ";
      }
      print STDERR
          "The offending line is \"$_\".  Sequence is being ignored.\n";
      $badSequence = 1;
    }
